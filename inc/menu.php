...
<nav id="navbar-auto-hidden" >
        <div class="row hidden-xs">
            <div class="col-xs-4">
                ...
                <p class="text-navbar tittles-pages-logos" >Falabella</p>
            </div>
            <div class="col-xs-8">
                <div class="contenedor-tabla pull-right">
                    <div class="contenedor-tr" style="font-size: 12px;">
                        ...
                        <a href="#registro" class="table-cell-td">Registro</a>
                                    <a href^="#" class="table-cell-td carrito-button-nav all-elements-tooltip" data-toggle="tooltip" data-placement="bottom" title="Ver carrito de compras">
                                     ...
                                     <a href^="#" class="table-cell-td" data-toggle="modal" data-target=".modal-login"><i class="fa fa-user"></i>&nbsp;&nbsp;Login
                          </a>
      ...
      <div class="modal-dialog modal-sm">
          <div class="modal-content" id="modal-form-login">
                <div class="modal-header">
                  ...
                  <h4 class="modal-title text-center text-primary" id="myModalLabel">Iniciar sesión en Saga <br>Falabella</h4>
                </div>
...
<!-- ESTA PARTE SERA CON PHP _ NO LA TOQUEN -->
    <!-- Menu lateral -->
    <div id="mobile-menu-list" class="hidden-sm hidden-md hidden-lg" style="background:#000000; z-index:9999999;">
        <br>
        <h3 class="text-center tittles-pages-logos">Saga Falabella</h3>
