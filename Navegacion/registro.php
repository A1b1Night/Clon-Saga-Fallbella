        ...
        <div class="container">
            <div class="row">
                <div class="page-header">
                  <h1 style="text-align: center;">Registro de usuarios <small class="tittles-pages-logos">Falabella</small></h1>
                </div>
                <div class="col-xs-12 col-sm-6 text-center">
                   <br><br><br>
                    ...
                    <br>
                    <img src="img/img-registration.png" width="500" height="595">
                </div>
